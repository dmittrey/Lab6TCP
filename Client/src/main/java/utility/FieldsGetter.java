...
public class FieldsGetter implements FieldsReceiver {
    ...
    public FieldsGetter(ConsoleWorker aConsole) {
        console = aConsole;
    }
    ...
    private String getUniversalRequest(String requestField, String options, ConsoleWorker console, boolean nullAvailable) throws IOException {
    ...
    private Object getGeneralRequest(String requestField, String options,
                                     ConsoleWorker console, boolean minExist, boolean nullAvailable, TypeOfArgument type) {
    ...
    private String getFirstEnumRequest(String requestField, String enumerateList, ConsoleWorker console) {
    ...
    private String getUniversalEnumRequest(String requestField, ConsoleWorker console) {
